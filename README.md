...
Welcome to the **GK Store** – a football shirt e-commerce application. Built with **Next.js**, **React**, **TypeScript (TSX)**, and **PostgreSQL** for the database, with **Tailwind CSS** for styling.
